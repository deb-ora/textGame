...
const btnOptsElement = document.getElementById("opt-btns");
...
function showTextNode(textNodeIndex) {
  ...
  while (btnOptsElement.firstChild) {
    btnOptsElement.removeChild(btnOptsElement.firstChild);
  }
  ...
  textNode.options.forEach((option) => {
    if (showOption(option)) {
      ...
      btnOptsElement.appendChild(button);
    }
  });
}
...
const textNodes = [
    ...
    options: [
      {
        ...
        //  **precisa cehcar stado caso true e apontar pra proximo step
        nextText: 2,
      },
      {
        text: "leave the goo",
  ...
  },
  {
    id: 2,
    text:
      "You venture forth in search of answers to wher eyou are when you come across a merchant",
    options: [
      {
